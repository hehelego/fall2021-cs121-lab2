...
static __global__ void updateKernel(u32 *keys, std::pair<u32, u32> *result, u32 n, u32 cap, u32 **slots, const u32* const seeds, u32 m, u32 threshold, u32 *counter) {
...
static __global__ void queryKernel(const u32 *keys, u32 *result, u32 n, u32 cap, u32 **const slots, const u32* const seeds, u32 m) {
  u32 cachedSeeds[M_HASH_FUNCS];
  for(u32 i=0;i<M_HASH_FUNCS;i++) cachedSeeds[i]=seeds[i];
